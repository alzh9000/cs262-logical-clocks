...
parser.add_argument('-s', '--server-port', type=int, help='the port number to listen on for incoming connections')
parser.add_argument('-p1', '--peer1-port', type=int, help='the port number to connect to for the first peer')
parser.add_argument('-p2', '--peer2-port', type=int, help='the port number to connect to for the second peer')
